...
| [`json_schema_passes`](/docs/rules/structured-query/json_schema_passes/) | Validate every JSON / YAML / TOML / XML / dotenv file in `paths` against a JSON Schema document. |
