...
### A Terraform instance on the wrong count
...
```ansi
[2m--- main.tf --------------------------------------------------------------------[0m
  [1m[31mx  error  [0m  [2msingle-instance[0m
              value at path does not equal expected: expected 1, got 2
...
### A Terraform instance on the canonical count
