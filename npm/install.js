...
async function main() {
  ...
  if (skipReason) {
    process.stderr.write(`@asamarts/alint: skipping postinstall (${skipReason})\n`);
    return;
  }
  ...
  process.stderr.write(`@asamarts/alint: downloading ${archive}\n`);
  ...
  process.stderr.write(`@asamarts/alint: SHA-256 verified\n`);
