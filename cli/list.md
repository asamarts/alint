---
title: 'alint list'
description: 'List the rules loaded from THIS repo''s effective config. alint list CLI reference and flags.'
---

```
List the rules loaded from THIS repo's effective config. To browse the full catalog of rule kinds alint ships, use `alint rules list`

Usage: alint list [OPTIONS]

Options:
  -c, --config <CONFIG>      Path to a config file
      --category <CATEGORY>  Only rules whose kind is in this category (slug; see `alint rules categories`)
