...
- ⏳ `extends`: ✅ local files (recursive resolution, cycle detection, child-overrides-parent merge); ⏳ HTTPS URLs with SHA-256 SRI and caching under `~/.cache/alint/rulesets/`.
