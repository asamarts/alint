...
### `json_path_matches`, `yaml_path_matches`, `toml_path_matches`, `xml_path_matches`, `dotenv_path_matches`, `properties_path_matches`, `ini_path_matches`
...
### `json_path_absent`, `yaml_path_absent`, `toml_path_absent`, `xml_path_absent`, `dotenv_path_absent`, `properties_path_absent`, `ini_path_absent`
